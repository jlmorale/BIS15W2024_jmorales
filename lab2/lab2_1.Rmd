...
The way I interpret this result is that there is a mean of NA so there was a value of missing data. With just one NA present the program will not calculate the mean.  
