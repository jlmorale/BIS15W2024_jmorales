...
The difference between R and R studio is that R is the coding language, while R studio is where it makes writing the R scripts easier to run the R programming experience.  
