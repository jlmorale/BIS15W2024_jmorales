...
```
## # A tibble: 25 × 3
##    name           height alignment
##    <chr>           <dbl> <chr>    
##  1 Abomination       203 bad      
##  2 Alien             244 bad      
##  3 Amazo             257 bad      
##  4 Apocalypse        213 bad      
##  5 Bane              203 bad      
##  6 Bloodaxe          218 bad      
##  7 Darkseid          267 bad      
##  8 Doctor Doom       201 bad      
##  9 Doctor Doom II    201 bad      
## 10 Doomsday          244 bad      
## # ℹ 15 more rows
```
...
```
## # A tibble: 1 × 14
##   accelerated_healing durability flight longevity intelligence super_strength
##   <lgl>               <lgl>      <lgl>  <lgl>     <lgl>        <lgl>         
## 1 TRUE                TRUE       TRUE   TRUE      TRUE         TRUE          
## # ℹ 8 more variables: stamina <lgl>, energy_beams <lgl>, magic <lgl>,
## #   shapeshifting <lgl>, psionic_powers <lgl>,
